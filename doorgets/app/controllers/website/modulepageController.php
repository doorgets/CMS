...
class ModulePageController extends doorgetsWebsiteController{
    ...
    public function setContent() {
        ...
        $isContent = $this->Website->dbQS($module,'_dg_page','uri');
        if (!empty($isContent)) {
            
            $lgTraductionIds = @unserialize($isContent['groupe_traduction']);
            $idTraduction = $lgTraductionIds[$this->Website->myLanguage()];
            
            $isContentTraduction = $this->Website->dbQS($idTraduction,'_dg_page_traduction');

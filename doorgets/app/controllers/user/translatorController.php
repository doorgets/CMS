...
class TranslatorController extends doorGetsUserController{
    
    public function __construct(&$doorGets) {
        
        $doorGets->Table = '_dg_translator';
        ...
        if (!in_array('traduction',$doorGets->user['liste_module_interne']) 
        ...
        if (array_key_exists('id',$params['GET']))
        {
            ...
            if (empty($isContent)) {
                ...
                header('Location:./?controller=translator'); exit();
    ...
    public function tofileAction() {
        ...
        $this->doorGets->Form['_saveToFile']      = new Formulaire('doorGets_save_to_file');
    ...
    public function tobaseAction() {
        
        $this->doorGets->Form['_saveToBase']    = new Formulaire('doorGets_save_to_base');

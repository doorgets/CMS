...
class OrderController extends doorGetsUserController{
    
    public function __construct(&$doorGets) {
        
        $doorGets->Table = '_order';
        ...
        if (!in_array('order',$doorGets->user['liste_module_interne'])
            || ( in_array('order',  $doorGets->user['liste_module_interne']) && SAAS_ENV && !SAAS_ORDER)) {
    ...
    public function selectAction() {
        ...
        $this->doorGets->Form['status'] = new Formulaire($this->doorGets->controllerNameNow().'_status');

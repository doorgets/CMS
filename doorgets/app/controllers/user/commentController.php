...
class CommentController extends doorGetsUserController{
    
    public function __construct(&$doorGets) {
        
        $doorGets->Table = '_dg_comments';
        ...
        if (!in_array('comment',$doorGets->user['liste_module_interne'])
    ...
    public function selectAction() {
        ...
        $this->doorGets->Form = new Formulaire($this->doorGets->controllerNameNow().'_activation');

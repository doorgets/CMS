...
class EmailnotificationController extends doorGetsUserController{
    
    public function __construct(&$doorGets) {
        
        $doorGets->Table = '_dg_email_notification';
        ...
        if (!in_array('emailnotification',$doorGets->user['liste_module_interne'])
        ...
        if (array_key_exists('id',$params['GET']))
        {
            ...
            if (empty($isContent)) {
                ...
                header('Location:./?controller=emailnotification'); exit();

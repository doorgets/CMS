...
class ModuleSharedlinksRequest extends doorGetsUserModuleRequest{
    ...
    public function doAction() {
        ...
        try {
            ...
            $champsNonObligatoire = array('description','image','meta_titre','meta_description','meta_keys','sendto','id_disqus','image_gallery','meta_facebook_titre','meta_facebook_description','meta_facebook_image',
            ...
            switch($this->Action) {
                ...
                case 'add':
                   ...
                   if (!empty($this->doorGets->Form->i)) {
                        ...
                        $urlToShare = $this->doorGets->Form->i['url'];
                        if (filter_var($urlToShare, FILTER_VALIDATE_URL) === false) {
                            $this->doorGets->Form->e[$this->doorGets->controllerNameNow().'_add_url'] = 'ok';
                        }
                ...
                case 'edit':
                    ...
                    if (!empty($this->doorGets->Form->i) && $user_can_edit) {
                        ...
                        $urlToShare = $this->doorGets->Form->i['url'];
                        if (filter_var($urlToShare, FILTER_VALIDATE_URL) === false) {
                            $this->doorGets->Form->e[$this->doorGets->controllerNameNow().'_edit_url'] = 'ok';
                        }

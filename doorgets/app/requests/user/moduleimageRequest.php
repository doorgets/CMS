...
class ModuleImageRequest extends doorGetsUserModuleRequest{
    ...
    public function doAction() {
        ...
        $champsNonObligatoire = array('article_tinymce','meta_titre','meta_description','meta_keys','sendto','id_disqus','image_gallery','meta_facebook_titre','meta_facebook_description','meta_facebook_image',
            ...
            case 'add':
                ...
                if (!empty($this->doorGets->Form->i)) {
                    ...
                    if (    isset($_FILES[$cName.'_add_image']) &&
                        ...
                        $this->doorGets->Form->e[$cName.'_add_image'] = 'ok';
                    }
                    ...
                    if (empty($this->doorGets->Form->e)) {
                        ...
                        $nameFileImage = $uni.'-'.$this->doorGets->Uri;
                        
                        $this->doorGets->Form->i['image'] = $nameFileImage;
                        $send_img = UploadImage::send($this->doorGets->getRealUri($this->doorGets->Uri),$_FILES[$cName.'_add_image']['tmp_name'],$_FILES[$cName.'_add_image']['name'],$nameFileImage,257);
                        if ($send_img !== null) {
                            $this->doorGets->Form->i['image'] = strtolower($send_img);   
                        }
            ...
            case 'edit':
                ...
                if (!empty($this->doorGets->Form->i) && $user_can_edit) {
                    ...
                    if (empty($this->doorGets->Form->e)) {
                        ...
                        $send_img = UploadImage::send($this->doorGets->getRealUri($this->doorGets->Uri),$_FILES[$cName.'_edit_image']['tmp_name'],$_FILES[$cName.'_edit_image']['name'],$nameFileImage,257);
                        if ($send_img !== null) {
                            $this->doorGets->Form->i['image'] = strtolower($send_img);   
                        }

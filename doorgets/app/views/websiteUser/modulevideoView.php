...
class moduleVideoView extends doorgetsWebsiteUserView{
    ...
    public function getContent() {
        ...
        $templateDefault = 'modules/video/video_listing';
        $templateDefaultContent = 'modules/video/video_content';
        ...
        if ($Website->getPosition() === 'root' || $Website->getPosition() === 'category') {
            ...
            $urlAdd             = URL_USER.$Website->_lgUrl.'?controller=modulevideo&uri='.$Website->getModule().'&action=add&back='.$urlAfterAction;
            ...
            $urlEdition         = URL_USER.$Website->_lgUrl.'?controller=modulevideo&uri='.$Website->getModule().'&action=edit&id='.$isContent['id_content'].'&lg='.$Website->getLangueTradution().'&back='.$urlAfterAction;
            $urlDelete          = URL_USER.$Website->_lgUrl.'?controller=modulevideo&uri='.$Website->getModule().'&action=delete&id='.$isContent['id_content'].'&lg='.$Website->getLangueTradution();
            $urlAdd             = URL_USER.$Website->_lgUrl.'?controller=modulevideo&uri='.$Website->getModule().'&action=add&back='.$urlAfterAction;

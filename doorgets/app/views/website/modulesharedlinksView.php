...
class moduleSharedlinksView extends doorgetsWebsiteView{
    ...
    public function getContent() {
        ...
        if ($Website->getPosition() === 'root' || $Website->getPosition() === 'category') {
            ...
            $champsliste[] = $nameTable.'_traduction.url';
            ...
            if (!empty($isContent)) {
                ...
                if (!empty($isContentActive)) {
                    ...
                    $isContent['article'] = html_entity_decode($isContent['url']);
                    ...
                    if (!empty($isContentActive)) {
                        ...
                        $isContent['article'] = html_entity_decode($isContentActiveVersion['url']);
                        $isContent['article'] = $Website->_convertMethod($isContent['article']);
            ...
            $urlEdition         = URL_USER.$Website->_lgUrl.'?controller=modulesharedlinks&uri='.$Website->getModule().'&action=edit&id='.$isContent['id_content'].'&lg='.$Website->getLangueTradution().'&back='.$urlAfterAction;

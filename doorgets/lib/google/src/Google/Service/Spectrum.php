...
class Google_Service_Spectrum_Vcard extends Google_Model
{
  ...
  protected $telType = 'Google_Service_Spectrum_VcardTéléphone';
  ...
  public function setTel(Google_Service_Spectrum_VcardTéléphone $tel)
  {
    $this->tel = $tel;
  }
...
class Google_Service_Spectrum_VcardTéléphone extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $uri;

...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            <span class="create" ><a class="doorGets-comebackform" href="?controller=modulecategory&uri=[{!$this->doorGets->Uri!}]"><img src="[{!BASE_IMG!}]retour.png" class="Retour-img"> [{!$this->doorGets->__('Retour')!}]</a></span>
            ...
            / [{!$this->doorGets->__('Supprimer une catégorie')!}] : [{!$isContent['nom']!}]
        </legend>
        
        [{?(empty($isArcticleIn)):}]

            [{!$this->doorGets->Form->open('post','','');}]
                [{!$this->doorGets->Form->input('','id','hidden',$isContent['id_cat']);}]
                <div class="title-box alert alert-danger text-center">
                    [{!$this->doorGets->__("Voulez vous supprimer cette catégorie définitivement")!}] ?
                </div>
        ...
        <div class="alert alert-info">
            [{!$this->doorGets->__("Cette catégorie est utilisée par un ou plusieurs articles, merci de les supprimer pour pouvoir supprimer cette catégorie.");}]

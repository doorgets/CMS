...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            [{!$htmlAddTop!}]
            : [{!$this->doorGets->__('Ajouter un partenaire')!}] 
        </legend>
        ...
        <div >
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tabs-1">
                    ...
                    <div class="separateur-tb"></div>
                    [{!$this->doorGets->Form->textarea($this->doorGets->__('Description').' <span class="cp-obli">*</span>','description');}]
                    <div class="separateur-tb"></div>
                    [{!$this->doorGets->Form->fileAjax($this->doorGets->__('Image').' <span class="cp-obli">*</span>','image');}]
                    <div class="separateur-tb"></div>
                    [{!$this->doorGets->Form->input($this->doorGets->__('Site internet').' <span class="cp-obli">*</span>','url');}]
                    <div class="separateur-tb"></div>
                </div>
            </div>
        </div>

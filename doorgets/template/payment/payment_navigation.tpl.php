...
$hasSubscription = (empty($subscription))?false:true;
...
<div class="navbar navbar-default navbar-static-top " >
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="[{!$BASE_URL!}]" class="navbar-brand" title="[{!'cool'!}]"><img class="ico-logo-payment" src="[{!URL!}]skin/img/logo_backoffice.png"/></a>  
        </div>
        ...
        [{!$this->getView('payment/payment_navbar',$paramsNavbar)!}]
    </div>   
</div>

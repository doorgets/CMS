...
<div id="sidebar-wrapper">
    <ul class="sidebar-nav list-group">
        <li class="sidebar-brand">
            ...
            <a href="#menu-toggle-top-bis" id="menu-toggle-top-bis" title="[{!$doorGets->__('Afficher le menu')!}]">
                <b class="glyphicon violet glyphicon-triangle-bottom"></b>
            </a>
        </li>
        ...
        [?]
        [{?(in_array('groupes', $doorGets->user['liste_module_interne'])):}]
        ...
        [?]
        [{?(in_array('attributes', $doorGets->user['liste_module_interne'])):}]
        ...
        [?]
        [{?(in_array('media', $doorGets->user['liste_module_interne'])):}]  
        ...
        [?]
        [{?(in_array('traduction', $doorGets->user['liste_module_interne'])):}]  
        ...
        [?]
        [{?(in_array('campagne_email', $doorGets->user['liste_module_interne'])):}]
        ...
        [?]
        [{?(in_array('emailnotification', $doorGets->user['liste_module_interne'])):}]                

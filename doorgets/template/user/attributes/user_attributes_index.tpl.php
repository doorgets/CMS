...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            <span class="create" ><a href="?controller=attributes&action=add"class="violet" ><b class="glyphicon glyphicon-plus"></b>  [{!$this->doorGets->__('Créer un attribut')!}]</a></span>
            <span class="create">[{!$this->doorGets->genLangueMenuAdmin()!}]</span>
            <b class="glyphicon glyphicon-pushpin"></b> [{!$this->doorGets->__('Attributs')!}] 
        </legend>
        <div style="width: 100%;padding: 10px 0 0;overflow: hidden;">
            ...
            <div style="overflow: hidden;">
                    ...
                    <i>
                        ...
                        <b>[{!$cResultsInt.' '!}] [{?( $cResultsInt > 1 ):}][{!$this->doorGets->__('Attributs')!}] [??] [{!$this->doorGets->__('Attribut')!}] [?]</b>
            ...
            [??]
                ...
                [{?(!empty($aGroupeFilter)):}]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Aucun attribut trouvé pour votre recherche.");}]
                    </div>
                [??]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Il n'y a actuellement aucun attribut")!}]
                    </div>
                [?]

...
<div class="doorGets-rubrique-center">
    <div class="doorGets-rubrique-center-content">
        ...
        <legend>
            <span class="create" ><a class="doorGets-comebackform" href="?controller=groupes&lg=[{!$lgActuel!}]"><img src="[{!BASE_IMG!}]retour.png" class="Retour-img"> [{!$this->doorGets->__('Retour');}]</a></span>
        ...
        <div >
            ...
            <div class="tab-content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            [{?(!empty($activeGroupesParents)):}]
                                ...
                                [/]
                            [??]
                                <div>[{!$this->doorGets->__("Il n'y a aucun parent pour ce groupe")!}]</span></div>
                            [?]
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="tabs-6">
                    ...
                    [{!$this->doorGets->Form->checkbox('CKEditor : <a href="http://ckeditor.com/" target="blank">http://ckeditor.com/</a>','editor_ckeditor','active',$check);}]
                    <div class="separateur-tb"></div>
                    [{$check = ""; if ($activeEditorTinymce) {$check = 'checked';} }]
                    [{!$this->doorGets->Form->checkbox('TinyMCE : <a href="http://www.tinymce.com/" target="blank">http://www.tinymce.com/</a>','editor_tinymce','active',$check);}]

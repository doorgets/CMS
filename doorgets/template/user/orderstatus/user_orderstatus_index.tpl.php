...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            [{!$storeMenuHtml!}]
            <span class="create" ><a href="?controller=[{!$this->doorGets->controllerNameNow()!}]&action=add"class="violet" ><b class="glyphicon glyphicon-plus"></b>  [{!$this->doorGets->__('Créer un état de commande')!}]</a></span>
            <span class="create">[{!$this->doorGets->genLangueMenuAdmin()!}]</span>
            <i class="fa fa-undo"></i> [{!$this->doorGets->__('États des commandes')!}] 
        </legend>

...
<div class="doorGets-rubrique-center">
    <div class="doorGets-rubrique-center-content">
        ...
        <legend>
            ...
            <i class="fa fa-undo"></i> <a href="?controller=[{!$this->doorGets->controllerNameNow()!}]">[{!$this->doorGets->__('États des commandes')!}] </a> 
             /  [{!$isContent['title']!}]
             
        </legend>
        <div class="title-box alert alert-danger text-center">
            [{!$this->doorGets->__("Voulez vous supprimer cet état définitivement")!}] ?
        </div>

...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            [{!$storeMenuHtml!}]
            <span class="create" ><a href="?controller=[{!$this->doorGets->controllerNameNow()!}]&action=add"class="violet" ><b class="glyphicon glyphicon-plus"></b>  [{!$this->doorGets->__('Créer un état de retour produit')!}]</a></span>
            <span class="create">[{!$this->doorGets->genLangueMenuAdmin()!}]</span>
            <i class="fa fa-undo"></i> [{!$this->doorGets->__('États de retour produit')!}] 
        </legend>
        <div style="width: 100%;padding: 10px 0 0;overflow: hidden;">
            ...
            <div style="overflow: hidden;">
                    ...
                    <i>
                        ...
                        <b>[{!$cResultsInt.' '!}] [{?( $cResultsInt > 1 ):}][{!$this->doorGets->__('États')!}] [??] [{!$this->doorGets->__('État')!}] [?]</b>
            ...
            [??]
                [{?(!empty($aGroupeFilter)):}]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Aucun état trouvé pour votre recherche.");}]
                    </div>
                [??]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Il n'y a actuellement aucun état")!}]
                    </div>
                [?]

...
<div class="doorGets-rubrique-center">
    <div class="doorGets-rubrique-center-content">
        ...
        <legend>
            <span class="create" ><a href="?controller=[{!$this->doorGets->controllerNameNow()!}]&action=add"class="violet" ><b class="glyphicon glyphicon-plus"></b>  [{!$this->doorGets->__('Ajouter une notification')!}]</a></span>
                ...
                <div style="overflow: hidden;">
                    <div style="float: left;padding: 7px 0 ">
                        ...
                        <i>
                            ...
                            <b>[{!$cResultsInt.' '!}] [{?( $cResultsInt > 1 ):}][{!$this->doorGets->__('notifications')!}] [??] [{!$this->doorGets->__('notification')!}] [?]</b>

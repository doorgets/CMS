...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            [{!$storeMenuHtml!}]
            <span class="create" ><a href="?controller=[{!$this->doorGets->controllerNameNow()!}]&action=add"class="violet" ><b class="glyphicon glyphicon-plus"></b>  [{!$this->doorGets->__('Créer un message de commande')!}]</a></span>
            <span class="create">[{!$this->doorGets->genLangueMenuAdmin()!}]</span>
            <i class="fa fa-comments"></i> [{!$this->doorGets->__('Messages prédéfinis')!}] 
        </legend>

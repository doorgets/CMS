...
<div class="doorGets-rubrique-center">
    <div class="doorGets-rubrique-center-content">
        ...
        <legend>
            ...
            <b class="glyphicon violet glyphicon-folder-open"></b> [{!$this->doorGets->__('Media')!}]
        </legend>
                ...
                <div style="overflow: hidden;">
                    <div style="float: left;padding: 7px 0 ">
                        ...
                        <i>
                            ...
                            <b>[{!$cResultsInt.' '!}] [{?( $cResultsInt > 1 ):}][{!$this->doorGets->__('Fichiers')!}] [??] [{!$this->doorGets->__('Fichier')!}] [?]</b>
            ...
            [??]
                ...
                [{?(!empty($aGroupeFilter)):}]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Aucun fichier trouvé pour votre recherche.");}]
                    </div>
                [??]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Il n'y a actuellement aucun fichier")!}]
                    </div>
                [?]

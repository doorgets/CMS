                ...
                <div style="overflow: hidden;">
                    <div style="float: left;padding: 7px 0 ">
                        <i>
                            ...
                            <b>[{!$cResultsInt.' '!}] [{?( $cResultsInt > 1 ):}][{!$this->doorGets->__('Commentaires')!}] [??] [{!$this->doorGets->__('Commentaire')!}] [?]</b>
            ...
            [??]
                ...
                [{?(!empty($aGroupeFilter)):}]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Aucun commentaire trouvé pour votre recherche.");}]
                    </div>
                [??]
                    <div class="alert alert-info">
                        <i class="fa fa-exclamation-triangle"></i> [{!$this->doorGets->__("Il n'y a actuellement aucun commentaire")!}]
                    </div>
                [?]

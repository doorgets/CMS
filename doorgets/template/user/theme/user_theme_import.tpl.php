    ...
    <div class="doorGets-rubrique-center-content">
        ...
        <legend>
            ...
            <b class="glyphicon glyphicon-tint"></b> <a href="?controller=theme">[{!$this->doorGets->__('Thème')!}] </a> 
             / [{!$this->doorGets->__('Importer un nouveau thème')!}] 
         </legend>
        
        [{!$this->doorGets->Form->open('post')!}]
        [{!$this->doorGets->Form->file($this->doorGets->__('Choisir un fichier'),'file')!}]
        [{!$this->doorGets->Form->input('','hidden','hidden','hidden')!}]
        <div class="separateur-tb"></div>
        <div class="text-center">
            [{!$this->doorGets->Form->submit($this->doorGets->__('Importer'))!}]
        </div>

...
<div>
    ...
    <div class="action-bottom-inworks text-center" style="display: none;">
        ...
        [{!$translate->l("Création de votre sauvegarde en cours")!}]...[{!$translate->l("Veuillez patienter")!}]...
    </div>
    <div class="action-bottom-form ">
        ...
        <div class="text-center">
            [{!$form->submit($translate->l("Créer une sauvegarde de votre système maintenant"))!}]
        </div>
    </div>
    [{!$form->close()!}]
</div>
<script type="text/javascript">
  $("#backups_create_submit").click(function() {

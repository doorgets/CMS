...
?>
<legend>
        [{!$translate->l("Supprimer une sauvegarde")!}]
</legend>
<div class="text-center">
    [{!$form->open('post')!}]
    [{!$form->input('','delete','hidden','1')!}]
    [{!$this->getFileName()!}]
    ...
    <div class="action-bottom-inworks text-center" style="display: none;">
        ...
        [{!$translate->l("Suppréssion de votre sauvegarde en cours")!}]...[{!$translate->l("Veuillez patienter")!}]...
    </div>
    <div class="action-bottom-form text-center">
        [{!$form->submit($translate->l("Supprimer"),'','btn btn-danger bnt-lg')!}]
        
    </div>
    [{!$form->close()!}]
</div>
<script type="text/javascript">
  $("#backups_delete_submit").click(function() {

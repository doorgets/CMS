...
<div class="doorGets-rubrique-center">
    <div class="doorGets-rubrique-center-content">
        ...
        <legend>
            ...
            <b class="glyphicon violet glyphicon-send "></b> [{!$this->doorGets->__('Créer un contact')!}] 
        </legend>
        [{!$this->doorGets->Form->open('post')!}]
        [{!$this->doorGets->Form->input('','id_user','hidden',$this->user['id'])!}]
        [{!$this->doorGets->Form->input($this->doorGets->__('Nom').' <span class="cp-obli">*</span>','nom')!}]
        <div class="separateur-tb"></div>
        [{!$this->doorGets->Form->input($this->doorGets->__('Adresse email').' <span class="cp-obli">*</span>','email')!}]
        <div class="separateur-tb"></div>

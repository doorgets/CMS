...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        <legend>
            ...
            <b class="glyphicon glyphicon-asterisk"></b> <a href="?controller=modules&lg=[{!$lgActuel!}]">[{!$this->doorGets->__('Module')!}] </a> 
            / [{!$isContent['uri']!}]
        </legend>
        <div class="title-box alert alert-danger text-center">
            [{!$this->doorGets->__("Voulez vous supprimer le module définitivement")!}] ?
        </div>

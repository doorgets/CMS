...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','faq')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-4">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/faq/faq_listing.tpl.php');}]
                    [{!$this->doorGets->Form->input('','template_content','hidden','modules/faq/faq_listing');}]
                    <div class="separateur-tb"></div>
                </div>

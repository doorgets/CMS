        ...
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-5">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/blog/blog_listing.tpl.php');}]
                    <div class="separateur-tb"></div>
                    [{!$this->doorGets->Form->input('Content','template_content','text','modules/blog/blog_content.tpl.php');}]
                    <div class="separateur-tb"></div>
                </div>

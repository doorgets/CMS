...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','inbox')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-4">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/inbox/inbox_form.tpl.php');}]
                    [{!$this->doorGets->Form->input('','template_content','hidden','modules/inbox/inbox_form');}]
                    <div class="separateur-tb"></div>
                </div>

        ...
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-4">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/page/page_content.tpl.php');}]
                    [{!$this->doorGets->Form->input('','template_content','hidden','modules/page/page_content');}]
                    <div class="separateur-tb"></div>
                </div>

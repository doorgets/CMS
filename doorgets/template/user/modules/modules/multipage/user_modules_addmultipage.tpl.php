...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','multipage')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-4">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/multipage/multipage_listing.tpl.php');}]
                    [{!$this->doorGets->Form->input('','template_content','hidden','modules/multipage/multipage_listing');}]
                    <div class="separateur-tb"></div>
                </div>

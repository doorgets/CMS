...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','video')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-5">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/video/video_listing.tpl.php');}]
                    <div class="separateur-tb"></div>
                    [{!$this->doorGets->Form->input('Content','template_content','text','modules/video/video_content.tpl.php');}]
                    <div class="separateur-tb"></div>
                </div>

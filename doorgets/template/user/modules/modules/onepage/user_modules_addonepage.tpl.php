...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','page')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-4">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/onepage/onepage_content.tpl.php');}]
                    [{!$this->doorGets->Form->input('','template_content','hidden','modules/onepage/page_content');}]
                    <div class="separateur-tb"></div>
                </div>

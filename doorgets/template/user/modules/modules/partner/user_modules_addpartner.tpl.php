...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','partner')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-4">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/partner/partner_listing.tpl.php');}]
                    [{!$this->doorGets->Form->input('','template_content','hidden','modules/partner/partner_listing');}]
                    <div class="separateur-tb"></div>
                </div>

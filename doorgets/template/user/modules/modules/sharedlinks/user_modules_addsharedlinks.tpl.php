...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        [{!$this->doorGets->Form->input('','type','hidden','sharedlinks')!}]
        <div >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-3">
                    [{!$this->doorGets->Form->select($this->doorGets->__('Résultat').' ','bynum',$numGroupe,10);}]
                    <div class="separateur-tb"></div>
                ...
                <div class="tab-pane fade" id="tabs-5">
                    [{!$this->doorGets->Form->input('Index','template_index','text','modules/sharedlinks/sharedlinks_listing.tpl.php');}]
                    <div class="separateur-tb"></div>
                    [{!$this->doorGets->Form->input('Content','template_content','text','modules/sharedlinks/sharedlinks_content.tpl.php');}]
                    <div class="separateur-tb"></div>
                </div>

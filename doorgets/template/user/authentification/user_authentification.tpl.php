...
<div class="doorGets-box-login">
    ...
    [{?($fireWallIp['level'] < 6):}]
        <div>
            ...
            <a href="[{!BASE!}]/oauth2/google/login/" class="google-sigin">Se connecter avec Google</a> 
            <div class="separateur-tb"></div>
            [?]

            [{?($this->doorGets->configWeb['oauth_facebook_active']):}]
            <a href="[{!BASE!}]/oauth2/facebook/login/" class="facebook-sigin">Se connecter avec Facebook</a> 
            <div class="separateur-tb"></div>
            [?]

            [{!$this->doorGets->Form->input('<b class="glyphicon glyphicon-user"></b> '.$this->doorGets->__('Adresse électronique'),'login')!}]
            <br />
            [{!'<small class="right"><a href="?controller=authentification&action=forget">'.$this->doorGets->__('Mot de passe oublié').' ?</a></small>'.$this->doorGets->Form->input('<b class="glyphicon glyphicon-lock"></b> '.$this->doorGets->__('Mot de passe'),'password','password')!}]

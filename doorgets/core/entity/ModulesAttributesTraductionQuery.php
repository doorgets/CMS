...
class ModulesAttributesTraductionQuery extends AbstractQuery 
{

	protected $_table = '_modules_attributes_traduction';
    
    protected $_className = 'ModulesAttributesTraduction';

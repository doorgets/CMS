...
class UsersGroupesQuery extends AbstractQuery 
{
	...
	public function findRangeByPaymentAmountMonth($from,$to)
	{
		$this->_findRangeBy['PaymentAmountMonth'] =  array(
			'from' => $from,
			'to'   => $to
		);
	...
	public function findGreaterThanByPaymentAmountMonth($int)
	{
		$this->_findGreaterThanBy['PaymentAmountMonth'] = $int;
	...
	public function findLessThanByPaymentAmountMonth($int)
	{
		$this->_findLessThanBy['PaymentAmountMonth'] = $int;
	...
	public function filterRangeByPaymentAmountMonth($from,$to)
	{
		$this->_filterRangeBy['PaymentAmountMonth'] =  array(
			'from' => $from,
			'to'   => $to
		);
	...
	public function filterGreaterThanByPaymentAmountMonth($int)
	{
		$this->_filterGreaterThanBy['PaymentAmountMonth'] = $int;
	...
	public function filterLessThanByPaymentAmountMonth($int)
	{
		$this->_filterLessThanBy['PaymentAmountMonth'] = $int;

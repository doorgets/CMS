...
class DgCartEntity extends AbstractEntity
{
	...
	*/
	...
	public function getValidationProductType() {
		return array(
			'type'	         => 'varchar', 
			'size'			 => 255, 
			'unique' 		 => false,
	...
	public function getValidationProductId() {
		return array(
			'type'	         => 'int', 
			'size'			 => 11, 
			'unique' 		 => false,
	...
	public function getValidationProductUri() {
		return array(
			'type'	         => 'varchar', 
			'size'			 => 255, 
			'unique' 		 => false,
	...
	public function getValidationProductQuantity() {
		return array(
			'type'	         => 'int', 
			'size'			 => 255, 
			'unique' 		 => false,
	...
	public function getValidationProductPrice() {
		return array(
			'type'	         => 'decimal', 
			'size'			 => 7, 
			'unique' 		 => false,

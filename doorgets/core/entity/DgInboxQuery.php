...
class DgInboxQuery extends AbstractQuery 
{
	...
	public function findByTéléphone($Téléphone)
	{
		$this->_findBy['Téléphone'] =  $Téléphone;
	...
	public function findOneByTéléphone($Téléphone)
	{
		$this->_findOneBy['Téléphone'] =  $Téléphone;
	...
	public function findByLikeTéléphone($Téléphone)
	{
		$this->_findByLike['Téléphone'] =  $Téléphone;
	...
	public function filterByTéléphone($Téléphone, $condition = 'AND')
	{
		
		$_condition = $this->isAndOr($condition);
		$this->loadFilterBy('Téléphone',$Téléphone,$_condition);
	...
	public function filterLikeByTéléphone($Téléphone)
	{
		$this->_filterLikeBy['Téléphone'] =  $Téléphone;
	...
	public function orderByTéléphone($direction = 'ASC')
	{

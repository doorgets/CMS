...
class OrderStatusBackTraductionQuery extends AbstractQuery 
{

	protected $_table = '_order_status_back_traduction';
    
    protected $_className = 'OrderStatusBackTraduction';

...
class doorgetsWebsiteUser extends Langue{
    ...
    public function __construct($lg = '',$userId) {
        ...
        $this->autorizedModuleType = array('blog','news','video','image');
    ...
    public function getHtmlBlock($uri_module='') {
        ...
        if (array_key_exists($uri_module,$allModules)) {
            ...
            $tplBlock = Template::getWebsiteUserView('widgets/block',$this->getTheme());
    ...
    public function getHtmlForm($uri_module = '') {
        ...
        if (array_key_exists($uri_module,$allModules)) {
            ...
            $form = $this->genform[$uri_module]  = new Formulaire($uri_module);
            
            $dataGenForm = $this->_getGenFormFields(unserialize($Module['all']['extras']));
            
            // Modules GenForm init
            $this->initHtmlForm($uri_module,$Module,$dataGenForm);
            
            $tplForm = Template::getWebsiteUserView('widgets/form',$this->getTheme());
    ...
    public function getHtmlComment() {
        ...
        $tplComment = Template::getWebsiteUserView('widgets/comment',$this->getTheme());
    ...
    public function getHtmlCommentDisqus() {
        ...
        $tplDisqus = Template::getWebsiteUserView('widgets/comment_disqus',$this->getTheme());
    ...
    public function getHtmlCommentFacebook() {
        ...
        $tplFacebook = Template::getWebsiteUserView('widgets/comment_facebook',$this->getTheme());
    ...
    public function getHtmlSharethis() {
        ...
        $tplSharethis = Template::getWebsiteUserView('widgets/sharethis',$this->getTheme());
    ...
    public function getHtmlNewsletter() {
        ...
        $tplNewsletter = Template::getWebsiteUserView('widgets/newsletter',$this->getTheme());
    ...
    public function getHtmlNetwork() {
        ...
        $tplNetworks = Template::getWebsiteUserView('widgets/networks',$this->getTheme());
    ...
    public function getHtmlAnalytics() {
        ...
        $tplAnalytics = Template::getWebsiteUserView('widgets/analytics',$this->getTheme());
    ...
    public function getHtmlModuleComments() {
        ...
        $tplModuleComments = Template::getWebsiteUserView('widgets/comment_listing',$this->getTheme());
    ...
    public function getHtmlModuleSearch($q = '') {
        ...
        $tplModuleSearch = Template::getWebsiteUserView('widgets/module_search',$this->getTheme());
    ...
    public function getHtmlModuleCategories() {
        ...
        if ($this->type === 'multipage') {
            ...
            $this->loadUserCategories($this->module,$this->profile['id']);
            $categories = $this->categorieSimple_;
        }
        
        $tplModuleCategories = Template::getWebsiteUserView('widgets/module_categories',$this->getTheme());
                    ...
                    if (!empty($dOut)) {
                        ...
                        if (empty($isChallenge)) {
                            ...
                            if (!empty($moduleInfo) && !empty($moduleInfo['notification_mail'])) {
                                ...
                                new SendMailAlert($_email,$_sujet,'',$this);
    ...
    public function getHtmlWaitingPage() {
        ...
        $tplWantingPage = Template::getWebsiteUserView('waitingpage',$this->getTheme());
    ...
    public function getLastComments($count = 5) {
        ...
        $tplComments = Template::getWebsiteUserView('widgets/comment_last',$this->getTheme());

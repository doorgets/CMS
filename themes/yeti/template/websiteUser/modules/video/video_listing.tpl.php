...
?>
<!-- doorGets:start:modules/video/video_listing -->
<div class="doorGets-video-listing doorGets-module-[{!$Website->getModule()!}]">
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="btn-group pull-right btn-add-content">
                <a href="[{!$urlAdd!}]" class="btn btn-success btn-large">
                    ...
                    <span>[{!$Website->__('Ajouter une vidéo')!}]</span>
                </a>
            </div>
            [?]
            <ol class="breadcrumb">
            ...
            <div class="doorGets-listing-contents-title">
                [{!$ini!}] [{!$Website->__('à')!}] [{!$finalPer!}] [{!$Website->__('sur')!}] <b>[{!$totalContents!}] [{?($totalContents > 1):}] [{!$Website->__('vidéos')!}] [??]  [{!$Website->__('vidéo')!}][?]</b>
                [{?(!empty($q)):}]
            ...
            [{?(
                ...
                [{?(!empty($contents)):}]
                    <div class="row">
                    [{/($contents as $content):}]
                        <div  class="col-md-6 actived-[{!$content['active']!}]" >
                            <div class="list-group  hover-t">
                                
                                <div class="list-group-item " >
                                    <span  class="color-in"  >
                                        [{!ucfirst(mb_strtolower($content['title'],'UTF-8'))!}]
                                    </span>
                                    <span class="badge" >
                                ...
                                <div class="list-group-item center-g">
                                    <a href="[{!$Website->getBaseUrl();}]?[{!$Website->getModule()!}]=[{!$content['uri']!}]" title="[{!$content['title']!}]"  >
                                        <img alt="" src="https://i2.ytimg.com/vi/[{!$content['youtube']!}]/mqdefault.jpg" class="youtube" >
                                    </a>
                                </div>
                ...
                <div class="info-not-found">
                    [{!$Website->__('Aucune vidéo trouvée')!}] [{?(!empty($q)):}][{!$Website->__('pour votre recherche')!}][?].
                </div>
                [?]
                [{?(!empty($getPagination)):}]
                    <br /><br />
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                  <a href="[{!$Website->getBaseUrl();}]?[{$Website->getModule()!}]"><h3 class="panel-title">[{!$Website->__('Catégories')!}]</h3></a>
                </div>
...
<!-- doorGets:end:modules/video/video_listing -->

    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="doorGets-listing-contents-title">
                [{!$ini!}] [{!$Website->__('à')!}] [{!$finalPer!}] [{!$Website->__('sur')!}] <b>[{!$totalContents!}] [{?($totalContents > 1):}] [{!$Website->__('articles')!}] [??]  [{!$Website->__('article')!}][?]</b>
                [{?(!empty($q)):}]
            ...
            [{?(
                ...
                [{?(!empty($contents)):}]
                    [{/($contents as $content):}]
                        <div class="row content-listing-news actived-[{!$content['active']!}]">    
                ...
                <div class="info-not-found">
                    [{!$Website->__('Aucun article trouvée')!}] [{?(!empty($q)):}][{!$Website->__('pour votre recherche')!}][?].
                </div>
                [?]
                [{?(!empty($getPagination)):}]
                    <br /><br />

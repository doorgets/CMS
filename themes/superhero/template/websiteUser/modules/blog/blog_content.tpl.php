        ...
        <div class="col-md-9">
            ...
            <div class="btn-group pull-right btn-add-content">
                <a href="[{!$urlAdd!}]" class="btn btn-success btn-large">
                    ...
                    <span>[{!$Website->__('Créer un article')!}]</span>
                </a>
            </div>
            [?]
            <ol class="breadcrumb">
            ...
            <div class="doorGets-listing-contents left actived-[{!$isContent['active']!}]">
                ...
                <div class="infos-content-title">
                    [{?(!empty($linksToCategories)):}]<span class="right"> | [{!$linksToCategories!}] </span>[?]
                </div>
                <div>
                    <img src="[{!BASE!}]data/[{!$Website->getRealUri($Website->getModule())!}]/[{!$isContent['image']!}]" class="img-responsive  img-blog-content" />
                    [{!$isContent['article']!}]
                </div>

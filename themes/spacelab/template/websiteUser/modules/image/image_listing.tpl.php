    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="doorGets-listing-contents-title">
                [{!$ini!}] [{!$Website->__('à')!}] [{!$finalPer!}] [{!$Website->__('sur')!}] <b>[{!$totalContents!}] [{?($totalContents > 1):}] [{!$Website->__('images')!}] [??]  [{!$Website->__('image')!}][?]</b>
                [{?(!empty($q)):}]
            ...
            [{?(
                ...
                [{?(!empty($contents)):}]
                    <div class="row">
                    [{/($contents as $content):}]
                        <div class="col-md-3 col-xs-6 p-bottom-1  actived-[{!$content['active']!}]">
                            <a href="[{!$Website->getBaseUrl();}]?[{!$Website->getModule()!}]=[{!$content['uri']!}]" title="[{!$content['title']!}]">
                                <img src="[{!BASE!}]data/[{!$Website->getRealUri($Website->getModule())!}]/real/[{!$content['image']!}]" class="img-thumbnail   hover-t" />
                ...
                <div class="info-not-found">
                    [{!$Website->__('Aucune image trouvée')!}] [{?(!empty($q)):}][{!$Website->__('pour votre recherche')!}][?].
                </div>
                [?]
                [{?(!empty($getPagination)):}]
                    <br /><br />
